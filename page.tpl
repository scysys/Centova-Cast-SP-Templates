            ...
            <div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
                ...
                <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500">
                    <ul class="m-menu__nav ">
                        ...
                        <li class="m-menu__item" aria-haspopup="true" m-menu-link-redirect="1"><a href="/spreports/{$account.username}/index.php" target="_blank" rel="noopener" class="m-menu__link "><span class="m-menu__item-here"></span><i class="m-menu__link-icon icon-settings"></i><span class="m-menu__link-text">{="SPReports"}</span></a></li>
                        ...
                        <li class="m-menu__item m-menu__item--submen ifconfig-cccontrol" aria-haspopup="true" m-menu-submenu-toggle="hover"> <a href="javascript:;" class="m-menu__link m-menu__toggle"><span class="m-menu__item-here"></span><i class="m-menu__link-icon icon-settings"></i><span class="m-menu__link-text">Centova Cast: Control</span><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                            <div class="m-menu__submenu"><span class="m-menu__arrow"></span>
                                <ul class="m-menu__subnav">
